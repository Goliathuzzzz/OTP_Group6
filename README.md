...
3. [Matchmaking Algorithm](#matchmaking-algorithm)  
   3.1 [How It Works](#how-it-works)  
   3.2 [Interest-Based Matching](#interest-based-matching)  
   3.3 [Compatibility Scoring](#compatibility-scoring)  
   3.4 [Finding the Best Match](#finding-the-best-match)
4. [Technology Stack](#technology-stack)  
   4.1 [Frontend](#frontend)  
   4.2 [Backend](#backend)  
   4.3 [DevOps & Deployment](#devops--deployment)
5. [Database Design](#database-design)  
   5.1 [Entity-Relationship Diagram](#entity-relationship-diagram)  
   5.2 [Relational Schema](#relational-schema)  
   5.3 [Class Diagram](#class-diagram)  
   5.4 [Activity Diagram](#activity-diagram)
...
8. [Usage](#usage)
9. [Testing](#testing)
10. [Running the App with Docker](#running-the-app-with-docker)
